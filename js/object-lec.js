...
kenCar.make = "Chevrolet";

// Or array notation:

kenCar["model"] = "Silverado";
...
alert("Hey! I own a " + kenCar["make"] + " " + kenCar.model);

//We can tap into our prior understanding of assigning variables thus far and assign a property to a variable:

var myCarYear = kenCar.year;

alert("Whoops! I forgot to tell you what year my vehicle is! It's " + myCarYear);

//What if we wanted to create a more complicated piece of data? Perhaps a list of our cars FEATURES?

kenCar.features = ["heated/ventilated seats", "leather", "towing package"];

console.log(kenCar.features)

//Now we could do something like this. . a list of those features in the console

for(var i = 0;i < kenCar.features.length; i++) {
    console.log("Here's one of my car's features: " + kenCar.features[i]);
}

// TODO: Add an array of features that your vehicle has!

myDreamCar.features = ["self-drive", "electric battery", "netflix streaming", "heated seats"];
...
/* var otherCar = {
    ...
    owner: { firstname: "Sally",
        lastname: "Mae"},

};

kenCar.owner = carOwnerKen;
